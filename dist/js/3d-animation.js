//
const banner3d = document.querySelector("#banner3d");
//

function BannerMemento() {
  banner3d.addEventListener("mousemove", function (event) {
    const x = event.pageX;
    const y = event.pageY;

    const target = document.querySelector(".card-memento");
